...
import starIcon from '../assets/Icon (1).png';
  ...
  return (
    <div className="space-y-6 w-full text-left font-sans">
      <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-xs space-y-6">
        <div>
          <h2 className="text-base font-semibold text-gray-900">Rating Overview</h2>
          <p className="text-xs text-gray-400 mt-0.5">
            Your performance and customer satisfaction metrics
          </p>
        </div>
        <div className="grid grid-cols-3 gap-6 text-center py-2 border-b border-gray-100 pb-4">
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-xs space-y-4">
        <h2 className="text-base font-semibold text-gray-900">Rating Breakdown</h2>
                ...
                {[...Array(5)].map((_, index) => (
                  <img
                    ...
                    className={`w-3.5 h-3.5 object-contain ${
                      index < review.rating ? 'opacity-100' : 'opacity-25 grayscale'
                    }`}
                  />
                ))}
              </div>
