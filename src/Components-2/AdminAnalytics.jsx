...
import OrdersUsersChart from "./OrdersUsersChart";
                ...
                <div className="flex flex-col w-[831.2px] h-[603.17px] gap-[24px]">
                    ...
                    <div className="flex w-[831.2px] h-[236.03px] gap-[16px]">
                        <div className="w-[404px] h-[420px] bg-white border border-black/10 rounded-[14px] p-5">
                            <h2 className="text-[18px] font-medium">Revenue Trend</h2>
                            <p className="text-[14px] text-[#717182] mt-1">Monthly revenue over the last 6 months</p>
                            <div className="w-full h-[300px] mt-5">
                                <RevenueChart />
                            </div>
                        </div>
                        <div className="w-[403.6px] h-[419.6px] bg-white border border-black/10 rounded-[14px] p-5">
                            <h2 className="text-[18px] font-medium">Orders & Users</h2>
                            <p className="text-[14px] text-[#717182] mt-1">Monthly comparison of orders and users</p>
                            <div className="w-full h-[300px] mt-5">
                                <OrdersUsersChart />
                            </div>
                        </div>
